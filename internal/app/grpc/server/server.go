...
import (
	...
	service_template_api "github.com/proxeter/go-service-template/api"
	"github.com/proxeter/go-service-template/internal/app/config"
)
...
func (g *GRPC) Start(ctx context.Context) error {
	...
	service_template_api.RegisterHelloWorldServer(server, g)
...
func (g *GRPC) Get(ctx context.Context, req *service_template_api.Request) (*service_template_api.Response, error) {
	return &service_template_api.Response{Message: "Hello World"}, nil
}
